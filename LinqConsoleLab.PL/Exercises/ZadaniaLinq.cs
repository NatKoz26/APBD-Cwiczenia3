...
public sealed class ZadaniaLinq
{
    ...
    {
        var count = DaneUczelni.Zapisy
            .Count(z=>z.CzyAktywny);
        
        return new[]{$"Liczba aktywnych zapisów: {count}"};
    }
    ...
    public IEnumerable<string> Zadanie11_PolaczStudentowIZapisy()
    {
        return DaneUczelni.Studenci
            .Join(
                ...
                s=>s.Id,
                z=>z.StudentId,
                (s,z)=>$"{s.Imie} {s.Nazwisko} | {z.DataZapisu:d}"
            );
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                g=> g.Key,
                p=>p.Id,
                (g,p) =>$"{p.Nazwa} | {g.Average(z => z.OcenaKoncowa):F2}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        ...
        .Join(DaneUczelni.Zapisy,
            ...
            (p, z) => new { p, z })
        .GroupBy(x => x.p.Nazwa)
        .Where(g => g.All(x => x.z.OcenaKoncowa == null)) //chyba
        .Select(g => g.Key);
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        ...
        .Select(x =>
        {
            var oceny = x.zapisy.Where(z => z.OcenaKoncowa != null).ToList();
            var avg = oceny.Any() ? oceny.Average(z => z.OcenaKoncowa) : 0;

            return $"{x.pr.Imie} {x.pr.Nazwisko} | {avg:F2}";
        });
    }
